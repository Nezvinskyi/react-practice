...
const Counters = () => {
  ...
  return (
    <div className="todos">
      <h2>Counters</h2>
      <SingleCounterRedux title="Single Counter Redux" />
      <SingleCounterReduxToolkit title="Single Counter Redux Toolkit" />
      <SingleCounterReduxToolkitSlice title="Single Counter Redux Toolkit Slice" />
